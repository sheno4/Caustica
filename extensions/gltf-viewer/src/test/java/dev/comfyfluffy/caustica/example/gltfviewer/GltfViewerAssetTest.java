...
final class GltfViewerAssetTest {
    ...
    void retainsEachPrimitiveOnceAndPreservesAuthoredNodeInstances() {
        ...
        assertEquals(11.0, scene.placements().getFirst().at(new BlockPos(10, 20, 30)).translationX());
        assertEquals(22.0, scene.placements().getFirst().at(new BlockPos(10, 20, 30)).translationY());
        assertEquals(33.0, scene.placements().getFirst().at(new BlockPos(10, 20, 30)).translationZ());
