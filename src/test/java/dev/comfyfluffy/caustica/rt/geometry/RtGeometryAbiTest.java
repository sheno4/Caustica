...
final class RtGeometryAbiTest {
    ...
    void writesCanonicalGeometryRecordLayout() {
        ...
        assertEquals(3L, data.getLong(RtGeometryAbi.UV_ADDRESS_OFFSET));
        assertEquals(4L, data.getLong(RtGeometryAbi.DISPLACEMENT_ADDRESS_OFFSET));
        assertEquals(5f, data.getFloat(RtGeometryAbi.RIGID_DISPLACEMENT_OFFSET));
        assertEquals(6f, data.getFloat(RtGeometryAbi.RIGID_DISPLACEMENT_OFFSET + 4));
        assertEquals(7f, data.getFloat(RtGeometryAbi.RIGID_DISPLACEMENT_OFFSET + 8));
        assertEquals(0f, data.getFloat(RtGeometryAbi.RIGID_DISPLACEMENT_OFFSET + 12));
