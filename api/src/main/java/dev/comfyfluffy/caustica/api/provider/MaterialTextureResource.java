...
/**
 * GPU material-texture declaration for one named material in the current resource epoch. The resource
 * declares placement and authored OpenPBR streams; {@link #analysisSource()} supplies the canonical CPU
 * pixels from which the current page compiler builds those streams.
 */
