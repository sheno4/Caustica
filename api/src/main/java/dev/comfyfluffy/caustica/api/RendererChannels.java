...
/**
 * The renderer's retained-data channels, installed once by the host adapter. Extensions reach them through
 ...
 * session is current, drops submissions when none is, and reports that through
