...
/**
 * Immutable camera pose and projection. Position is absolute in the selected scene's coordinate units;
 * scene selection is carried separately by {@link SceneView}.
 *
