...
public interface RenderSessionContribution extends AutoCloseable {
     ...
     * while this method runs. Nothing may be submitted by this contribution after it returns.
     */
    default void stop() {
    }
     ...
     * has drained, and every retirement callback has returned. No session callback can reach the
     * contribution after this method starts. This is not a device-wide idle boundary; it only follows
     * drainage of work and objects in this contribution scope.
     */
    @Override
    default void close() {
    }
