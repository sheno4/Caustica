 ...
 * for the resource epoch; zero means the host cannot derive conservative coverage across animation.
 * The opened bundle uses these width/height dimensions for both albedo and semantic texel coordinates.
