 ...
 * <li>cancel pending compute jobs and program registrations, drain accepted submissions and frame uses,
 * run all terminal, readiness, and retirement callbacks, and close the now-drained pass instances;</li>
