 ...
 *
 * <p>The buffer remains renderer-owned. The extension owns only this range and releases it from its
 * shared owner's final-release callback. Each frame retains that owner through {@link dev.comfyfluffy.caustica.api.pass.PassFrame#retain}. A session-created pass may release its
