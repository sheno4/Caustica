...
public final class ComputeSynchronization {
    ...
    static final long COMPUTE_ACCESS = VK13.VK_ACCESS_2_SHADER_SAMPLED_READ_BIT
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            for (int index = 0; index < images.size(); index++) {
                ...
                barriers.get(index).sType$Default()
                        ...
                        .dstStageMask(COMPUTE).dstAccessMask(COMPUTE_ACCESS)
    ...
    /** Make storage writes visible to subsequent sampled-image and storage reads and writes. */
