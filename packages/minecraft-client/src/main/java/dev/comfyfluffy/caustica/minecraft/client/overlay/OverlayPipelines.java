...
final class OverlayPipelines {
    enum VertexFormat { NONE, POSITION, POSITION_TEX_COLOR, EDGE_POSITION_PAIR }
            ...
            try {
                return new Pipeline(ShaderObjectGraphics.create(gpu, vertexCode, fragmentCode,
                        switch (format) {
                            ...
                            case EDGE_POSITION_PAIR -> ShaderObjectGraphics.VertexFormat.EDGE_POSITION_PAIR;
                        }, topology, blend == Blend.ALPHA ? ShaderObjectGraphics.Blend.ALPHA
                                : ShaderObjectGraphics.Blend.NONE, samples, List.of(), fragmentMappings));
            } finally {
