...
final class RtTerrainLifecycleArchitectureTest {
    ...
    void frameAdapterDrivesOneTickAndOneRenderPass() throws IOException {
        String source = source("MinecraftFrameAdapter.java");
    ...
    void worldStopJoinsTerrainWorkersBeforeRuntimeGpuDrain() throws IOException {
        String session = source("program/MinecraftProgramSession.java");
        ...
        String runtime = Files.readString(TestProjectRoot.resolve(
    ...
    private static String source(String relative) throws IOException {
        return Files.readString(TestProjectRoot.resolve(
                "packages/minecraft-client/src/main/java/dev/comfyfluffy/caustica/minecraft/client").resolve(relative));
    }
